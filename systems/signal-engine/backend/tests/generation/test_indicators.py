...
from app.domain.generation import regime as regime_module
from app.domain.generation.indicators import (
    compute_cci,
    compute_indicator,
...
#
# These monkeypatch app.domain.generation.regime's own check_* functions (imported
