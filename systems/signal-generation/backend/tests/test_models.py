...
def test_strategy_create_requires_rule_id_for_in_house():
    with pytest.raises(ValidationError):
        StrategyCreate(
            name="x", source_type="in_house", horizon="intraday", instrument_type="spot", square_off_time="15:00:00",
        )
...
def test_strategy_create_square_off_time_optional_for_non_intraday():
    ...
    s = StrategyCreate(name="x", source_type="in_house", horizon="swing", instrument_type="spot", rule_id=RULE_ID)
    assert s.square_off_time is None


def test_strategy_create_positional_square_off_time_optional():
    s = StrategyCreate(name="x", source_type="in_house", horizon="positional", instrument_type="spot", rule_id=RULE_ID)
    assert s.square_off_time is None
...
def test_strategy_create_defaults_no_stop_loss():
    s = StrategyCreate(
        name="x", source_type="in_house", horizon="intraday", instrument_type="spot", rule_id=RULE_ID, square_off_time="15:00:00",
    )
...
def test_strategy_create_accepts_square_off_time_string():
    s = StrategyCreate(
        name="x", source_type="in_house", horizon="intraday", instrument_type="spot", rule_id=RULE_ID, square_off_time="14:30:00",
    )
...
def test_strategy_create_auto_fills_square_off_time_for_mcx_intraday():
    s = StrategyCreate(
        name="x", source_type="in_house", horizon="intraday", instrument_type="spot", rule_id=RULE_ID, segment="MCX",
    )
...
def test_strategy_create_auto_fills_square_off_time_for_crypto_intraday():
    s = StrategyCreate(
        name="x", source_type="in_house", horizon="intraday", instrument_type="spot", rule_id=RULE_ID, segment="CRYPTO",
    )
...
def test_strategy_create_explicit_square_off_time_overrides_default():
    s = StrategyCreate(
        name="x", source_type="in_house", horizon="intraday", instrument_type="spot", rule_id=RULE_ID, square_off_time="09:30:00",
    )
...
def test_strategy_create_defaults_option_fields():
    s = StrategyCreate(
        name="x", source_type="in_house", horizon="intraday", instrument_type="option", rule_id=RULE_ID, square_off_time="15:00:00",
    )
...
def test_strategy_create_accepts_expiry_day_filter_for_future():
    s = StrategyCreate(
        name="x", source_type="in_house", horizon="intraday", instrument_type="future", rule_id=RULE_ID, square_off_time="15:00:00",
