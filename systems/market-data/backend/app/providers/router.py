...
from app.providers.dhan import MCX_FUTCOM, NSE_EQ, NSE_FUTIDX, NSE_INDEX, DhanProvider
...
_dhan_nse = DhanProvider([NSE_EQ, NSE_INDEX, NSE_FUTIDX], name="dhan-nse")
_dhan_mcx = DhanProvider([MCX_FUTCOM], name="dhan-mcx")
