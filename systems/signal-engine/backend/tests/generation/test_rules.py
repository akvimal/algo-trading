...
from app.domain.generation.indicators import compute_rsi, compute_sma
from app.domain.generation.rule import CrossoverRuleConfig, RangeBreakoutRuleConfig
from app.domain.generation.rules import (
    CandleClose,
    bars_needed,
...
def test_evaluate_dispatches_supertrend_crossover():
    from app.domain.generation.indicators import compute_indicator, compute_indicator_signal
