...
def _matches_contract_day_filter(
    ...
    checked separately, in signal-processing's choose_option_strategy, where the
    ...
    post_signal(
        {
            ...
            # choose_option_strategy re-resolves the underlying itself (it needs
            ...
            # signal-processing's app/domain/processing/resolution/option_strategy.py
            # choose_option_strategy's own docstring for the chart_symbol vs
        ...
        post_signal(
            {
                "strategy_id": str(strategy.id),
                # For instrument_type='option', signal-processing's
                # choose_option_strategy re-resolves the underlying itself (it
                ...
                # app/domain/processing/resolution/option_strategy.py choose_option_strategy's own
