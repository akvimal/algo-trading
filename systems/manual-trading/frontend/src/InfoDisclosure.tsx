...
// execution's own InfoDisclosure (duplicated, not shared, matching this
// repo's usual per-frontend convention for small UI atoms) - the CSS for
// this already existed here (.info-disclosure*, index.css) from before
// the manual-trading split, just unused until now.
