...
app/domain/processing/resolution/option_strategy.py for where signal bias and
...
def naked_call(chain: dict, moneyness: str = "ATM") -> list[dict]:
    ...
    (option_position_style='naked', see app/domain/processing/resolution/option_strategy.py)
